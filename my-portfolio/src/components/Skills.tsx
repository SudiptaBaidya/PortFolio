    ...
    const skillCategories = [
        ...
        },
        {
            ...
            skills: [
                ...
                { name: "TypeScript", iconSvg: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 128 128"><path fill="#3178C6" d="M1.5 63.91v62.5h125v-125H1.5v62.5z" /><path fill="#FFF" d="M70.08 97.46c-2.33 2.15-5.32 3.23-8.99 3.23-4.52 0-8.21-1.39-11.08-4.18-2.87-2.79-4.31-6.19-4.31-10.23 0-3.1.84-5.91 2.51-8.43 1.67-2.52 4.1-4.7 7.28-6.53l5.03-2.61c2.16-1.14 4.04-2.22 5.64-3.23.05-.2.08-.4.08-.6v-3.8c0-2.37-.8-4.13-2.41-5.28-1.61-1.15-4.04-1.72-7.29-1.72-4.03 0-6.9.96-8.62 2.89-1.72 1.93-2.58 4.67-2.58 8.23H32.4c0-5.83 2.01-10.46 6.03-13.88 4.02-3.41 9.53-5.12 16.51-5.12 6.84 0 12.01 1.76 15.5 5.28 3.5 3.52 5.24 8.7 5.24 15.55v17.48c0 3.3.16 5.86.48 7.68h-11.75c-.27-1.15-.43-2.8-.48-4.96l-.11-4.77h-.42c-2.86 3.65-7.3 5.47-13.32 5.47zm3.11-17.65c-2 1.45-5.02 3.12-9.04 5.03-1.61.76-2.83 1.55-3.66 2.37-.83.82-1.25 1.77-1.25 2.85 0 1.25.43 2.27 1.29 3.05.86.78 2.08 1.17 3.66 1.17 2.12 0 4.05-.8 5.79-2.4 1.74-1.6 2.61-3.6 2.61-6v-6.07zM111.9 48.06h12.94v51.15H111.9V48.06zm-5.05-18.41a6.83 6.83 0 0 0-4.93-1.99 6.8 6.8 0 0 0-4.94 1.99 6.82 6.82 0 0 0-2.01 4.96c0 1.94.67 3.59 2.01 4.96 1.34 1.37 2.99 2.06 4.94 2.06 1.91 0 3.55-.69 4.93-2.06 1.37-1.37 2.06-3.02 2.06-4.96 0-1.96-.69-3.61-2.06-4.96z" /></svg> },
        ...
        },
        {
            ...
            skills: [
                ...
                { name: "AntiGravity", iconSvg: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v4m0 12v4M4.93 4.93l2.83 2.83m8.48 8.48l2.83 2.83M2 12h4m12 0h4M4.93 19.07l2.83-2.83m8.48-8.48l2.83-2.83" /><circle cx="12" cy="12" r="4" /></svg> },
                { name: "GitHub", iconSvg: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.166 6.839 9.489.5.092.682-.217.682-.482 0-.237-.008-.866-.013-1.7-2.782.603-3.369-1.34-3.369-1.34-.454-1.156-1.11-1.462-1.11-1.462-.908-.62.069-.608.069-.608 1.003.07 1.531 1.03 1.531 1.03.892 1.529 2.341 1.087 2.91.831.092-.646.35-1.086.636-1.336-2.22-.253-4.555-1.11-4.555-4.943 0-1.091.39-1.984 1.029-2.683-.103-.253-.446-1.27.098-2.647 0 0 .84-.269 2.75 1.025A9.578 9.578 0 0112 6.836c.85.004 1.705.114 2.504.336 1.909-1.294 2.747-1.025 2.747-1.025.546 1.377.203 2.394.1 2.647.64.699 1.028 1.592 1.028 2.683 0 3.842-2.339 4.687-4.566 4.935.359.309.678.919.678 1.852 0 1.336-.012 2.415-.012 2.743 0 .267.18.578.688.48C19.138 20.161 22 16.416 22 12c0-5.523-4.477-10-10-10z" /></svg> },
                { name: "Bruno", iconSvg: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#e86128" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="7" r="2" /><circle cx="5" cy="17" r="2" /><circle cx="19" cy="17" r="2" /><path d="M6.5 15.5L10 9M17.5 15.5L14 9M12 22v-3" /></svg> },
